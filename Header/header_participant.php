  <div class="main-bar">
        ...
        <ul>
            ...
            <li  class="active"><a href="liste_participants.php"><i class="fa fa-group" aria-hidden="true"></i> Participants</a></li>
            <li><a href="../societe/liste_societe.php"><i class="fa fa-building" aria-hidden="true"></i> Sociétes</a></li>
            <li><a href="../../recherche_participant.php"><i class="fa fa-search" aria-hidden="true"></i> Rechercher</a></li>
